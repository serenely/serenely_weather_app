...
export default function HomeScreen() {
  return (
    <ParallaxScrollView
      headerBackgroundColor={{ light: '#a16bde', dark: '#a16bde' }}
      headerImage={
        <Image
          source={require('../../assets/images/serenely-wallpapers.jpg')}
          style={styles.reactLogo}
        />
      }>
      <ThemedView style={styles.titleContainer}>
        <ThemedText type="title">Serenely Weather App</ThemedText>
      </ThemedView>
